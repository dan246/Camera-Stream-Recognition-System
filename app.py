...
# 模型 URL
API_USER = os.getenv("API_USER", "iSeek@intemotech.com")
API_PASSWORD = os.getenv("API_PASSWORD", "Ad12345@")
CAMERA_SERVICE_URL = os.getenv("CAMERA_SERVICE_URL", "http://192.168.50.28")
# 初始化 YOLO 模型
firesmokeryolo = YOLOModel(os.getenv("FIRESMOKER_MODEL_URL", "https://ftpweb.intemotech.com/autotrain/SmartCity_Smoke_s_1280_0420_V1/weights/best.pt"))
fallyolo = YOLOModel(os.getenv("FALL_MODEL_URL", "https://ftpweb.intemotech.com/autotrain/SmartCity_Fall_s_1280_0422_v3/weights/best.pt"))
wateryolo = YOLOModel(os.getenv("WATER_MODEL_URL", "https://ftpweb.intemotech.com/autotrain/firesmoke2024_03_15_v1/weights/best.pt"))
